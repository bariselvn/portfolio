...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      top-[120px] mx-w-7xl mx-auto flex flex-row items-start
      gap-5`}>
        ...
        <div>
          ...
          className="text-[#915eff]">Barış </span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop services, user <br className="sm:block hidden" />
            interfaces, server and client side applications 
          </p>
        </div>
      </div>
